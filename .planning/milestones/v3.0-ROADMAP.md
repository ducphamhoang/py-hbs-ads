...
Plans:
- [x] 14-01-PLAN.md — TDD RED phase: staffing_risk.py stub + failing test suite (all RISK/ROUT requirements)
- [x] 14-02-PLAN.md — TDD GREEN phase: full detect_risks() and compute_routing_recommendation() implementation
...
| 14. Staffing Risk Module and Follow-Up Routing | 3/3 | Complete    | 2026-04-29 |
